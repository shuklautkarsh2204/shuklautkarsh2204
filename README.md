...
💻 AI/ML Developer  
🚀 Building real-world intelligent systems and practical software projects  
🐍 Python Programmer  
...
An AI-powered cyber threat detection system that analyzes network traffic and identifies suspicious activities in real time using machine learning techniques.
...
#### Features
- Trained Logistic Regression model on 11,000+ phishing website samples and engineered URL-based features for classification.
- Detects anomalous network traffic using machine learning and visualizes alerts through an interactive dashboard.
